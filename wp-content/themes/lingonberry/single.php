			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="post-nav">
					...
					if (!empty( $prev_post )): ?>
						...
						<a class="post-nav-older" title="<?php _e('Previous post:', 'lingonberry'); echo ' ' . esc_attr(get_the_title($prev_post)); ?>" href="<?php echo get_permalink( $prev_post->ID ); ?>">&laquo; <?php echo get_the_title($prev_post); ?></a>
